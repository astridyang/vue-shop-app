			...
			<el-tabs v-model="activeName">
				<el-tab-pane label="注册与访问" name="first">
					...
					<el-form-item label="密码最小长度">
						<el-input v-model="form.password_min" type="number" style="width:200px;"></el-input>
					</el-form-item>
				...
				<el-tab-pane label="上传设置" name="second">
					...
					<el-form-item label="Bucket">
						<el-input v-model="form.upload_config.Bucket" style="width:200px;"></el-input>
					</el-form-item>
					<el-form-item label="ACCESS_KEY">
						<el-input v-model="form.upload_config.ACCESS_KEY" style="width:200px;"></el-input>
					</el-form-item>
					<el-form-item label="SECRET_KEY">
						<el-input v-model="form.upload_config.SECRET_KEY" style="width:200px;"></el-input>
					</el-form-item>
					<el-form-item label="空间域名">
						<el-input v-model="form.upload_config.http" style="width:200px;"></el-input>
						<small class="text-gray-400">请补全http:// 或 https://</small>
					</el-form-item>
				</el-tab-pane>
				<el-tab-pane label="API安全" name="third">
					<el-form-item label="是否开启API安全">
						...
						<small class="text-gray-400">api安全功能开启之后调用前端api需要传输签名串</small>
					</el-form-item>
					<el-form-item label="秘钥">
						<el-input v-model="form.api_secret" style="width:50%;"></el-input>
						<small
							class="text-gray-500 basis-full mt-1">秘钥设置关系系统中api调用传输签名串的编码规则，以及会员token解析，请慎重设置，注意设置之后对应会员要求重新登录获取token</small>
					</el-form-item>
				</el-tab-pane>
			</el-tabs>
